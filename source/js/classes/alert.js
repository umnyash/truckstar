...
class Alert extends Modal {
  constructor({ heading, status, text, buttonText }) {
    const modalElement = Alert.createElement({ heading, status, text, buttonText });
  ...
  static createElement({ heading, status, text, buttonText }) {
    const modalString = `
